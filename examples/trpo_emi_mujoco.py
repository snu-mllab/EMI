...
parser.add_argument('--nonlinearity_for_trpo', help='Choose the nonlinearity for all hidden layers in value and policy networks', choices=['relu', 'tanh'],
                    default='tanh')
parser.add_argument('--nonlinearity_for_embedding', help='Choose the nonlinearity for all hidden layers in all embedding-related networks', choices=['relu', 'tanh'],
                    default='relu')
